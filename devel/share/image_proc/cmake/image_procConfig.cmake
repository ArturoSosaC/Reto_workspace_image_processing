...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/inigo/Reto_workspace_image_processing/src/image_proc)
  set(image_proc_DEVEL_PREFIX /home/inigo/Reto_workspace_image_processing/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/inigo/Reto_workspace_image_processing/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'inigo <inigo@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/inigo/Reto_workspace_image_processing/src/image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/inigo/Reto_workspace_image_processing/devel/lib;/home/inigo/Reto_workspace_image_processing/devel/lib;/opt/ros/melodic/lib)
...
set(image_proc_EXPORTED_TARGETS "")
